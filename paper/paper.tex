\documentclass[aps,prl,twocolumn,showpacs,final]{revtex4-2}
\usepackage{graphicx}
\usepackage{color}
\usepackage{marvosym }
...
\begin{figure}[htbp]
\includegraphics[width=\columnwidth]{figs/paths.png}
